...
Generated on: 2026-07-25 13:34:17
...
## Configuration Data 
## ===----------------------------------------------------------------------===//
""" kernel: gemm,  cfgNum: 148"""
cfgbit_gemm = [
		0x0003, 0x0002, 0x0010,
		...
		0x1001, 0x0002, 0x00f0,
		0x0040, 0xf200, 0x00f1,
		0x07ff, 0x0001, 0x00f2,
		0x0002, 0x0100, 0x00f3,
		0x0000, 0x0000, 0x00f4,
		0x8000, 0x0000, 0x00f5,
		0x0000, 0x0000, 0x00f6,
		0x0000, 0x0000, 0x00f7,
		0x0020, 0x0040, 0x00f8,
		0x0040, 0x4080, 0x00f9,
		0x07fe, 0x8001, 0x00fa,
		0xfe30, 0x0107, 0x00fb,
		0x0000, 0x0000, 0x00fc,
		0x8000, 0x0000, 0x00fd,
		0x0000, 0x0000, 0x00fe,
		0x0000, 0x0000, 0x00ff,
		0x1000, 0x0000, 0x0100,
		0x0040, 0x0080, 0x0101,
		0x0000, 0x8001, 0x0102,
		0x0000, 0x0100, 0x0103,
		0x0000, 0x0000, 0x0104,
		0x8000, 0x0288, 0x0105,
		0x0000, 0x0000, 0x0106,
		0x0040, 0x0000, 0x0107,
		0x2000, 0x0000, 0x0108,
		0x0000, 0x0002, 0x0110,
		0x0000, 0x0000, 0x0129,
		0x0004, 0x0000, 0x0131,
		0x0100, 0x0000, 0x0149,
		0x0000, 0x3000, 0x0150,
		0x0110, 0x0000, 0x0169,
		0x0000, 0x0000, 0x0170,
		0x0020, 0x0000, 0x0171,
		0x0003, 0x0000, 0x0178,
		0x0003, 0x0200, 0x0179,
		0x0000, 0x0000, 0x017d,
		0x0000, 0xc000, 0x0188,
		0x0100, 0x0000, 0x0189,
		0x0004, 0x0008, 0x0190,
		0x0021, 0x0020, 0x0199,
		0x0000, 0x2000, 0x019a,
		0x0000, 0x041a, 0x019b,
		0x0000, 0x0020, 0x019c,
		0x0000, 0x0000, 0x019d,
		0x4001, 0x0240, 0x01a1,
		0x0000, 0x0000, 0x01a5,
		0xc000, 0x0000, 0x01a8,
		0x0002, 0x0000, 0x01a9,
		0x0000, 0x0000, 0x01b0,
		0x0002, 0x0000, 0x01b1,
		0x2001, 0x00a0, 0x01b9,
		0x0000, 0x0000, 0x01bd,
		0x1003, 0x01c0, 0x01c1,
		0x0000, 0x0000, 0x01c5,
		0x0000, 0x0100, 0x01c8,
		0x0300, 0x0100, 0x01d0,
		0x0040, 0x0040, 0x01d8,
		0x0040, 0x4080, 0x01d9,
		0x07fe, 0x8001, 0x01da,
		0xfe30, 0x0107, 0x01db,
		0x0000, 0x0000, 0x01dc,
		0x8000, 0x0000, 0x01dd,
		0x0000, 0x0000, 0x01de,
		0x0000, 0x0000, 0x01df,
		0x1000, 0x0000, 0x01e0,
		0x0040, 0x0000, 0x01e1,
		0x0000, 0x0001, 0x01e2,
		0x0000, 0x0100, 0x01e3,
		0x0000, 0x0000, 0x01e4,
		0x8000, 0x0270, 0x01e5,
		0x0000, 0x0000, 0x01e6,
		0x0000, 0x0000, 0x01e7,
		0x1000, 0x0000, 0x01e8,
		0x0040, 0x0080, 0x01e9,
		0x0000, 0x8001, 0x01ea,
		0x0000, 0x0100, 0x01eb,
		0x0000, 0x0000, 0x01ec,
		0x8000, 0x0000, 0x01ed,
		...
		0x0000, 0x0002, 0x01f8,
		0x4000, 0x0000, 0x0200,
		0xa001, 0x0130, 0x0209,
		0x0000, 0x0000, 0x020d,
		0x0002, 0x0000, 0x0210,
		0x0203, 0x0010, 0x0211,
		0x0000, 0x0000, 0x0215,
		0x0080, 0x0000, 0x0218,
		0x8004, 0x0000, 0x0298,
		0x0000, 0x0004, 0x02a0,
		0x0201, 0x00a0, 0x02a9,
		0x0000, 0x0000, 0x02ad,
		0x2003, 0x01b0, 0x02b1,
		0x0000, 0x0000, 0x02b5,
		0x0001, 0x0100, 0x02b8,
		0x0020, 0x0001, 0x02c0,
		0x1000, 0x0040, 0x02c8,
		0x0040, 0x4080, 0x02c9,
		0x07fe, 0x8001, 0x02ca,
		0xfe30, 0x0107, 0x02cb,
		0x0000, 0x0000, 0x02cc,
		0x8000, 0x0000, 0x02cd,
		0x0000, 0x0000, 0x02ce,
		0x0000, 0x0000, 0x02cf,
		0x0002, 0x0002, 0x02d0,
		0x0040, 0xf200, 0x02d1,
		0x07ff, 0x0001, 0x02d2,
		0x0002, 0x0100, 0x02d3,
...
async def gemm(runtime: DeviceRuntime, arg_0: ndarray, arg_1: ndarray, arg_2: ndarray):
    ...
    idata.append(arg_0[0:0+32,0:0+32])
    iptrs.append(DeviceData(0xc000, 4096))
